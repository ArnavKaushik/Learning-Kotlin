...
public class ComplexNumberTest {
    ...
    public void testGetRealPart() {
        assertEquals(3,c1.getRealPart());
        assertEquals(3,c2.getRealPart());
        assertEquals(-3,c3.getRealPart());
        assertEquals(-3,c4.getRealPart());
    }

    @Test
    public void testGetImaginaryPart() {
        assertEquals(4,c1.getImaginaryPart());
        assertEquals(-4,c2.getImaginaryPart());
        assertEquals(4,c3.getImaginaryPart());
        assertEquals(-4,c4.getImaginaryPart());
    }
